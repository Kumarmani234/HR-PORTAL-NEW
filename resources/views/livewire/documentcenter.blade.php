...
<p style="font-size: 16px;margin-top:5px;font-weight:normal">Documents</p>
    ...
    <div class="col-md-3" style=" border-radius: 5px; border: 1px solid #D9D9D9; background-color: white; display: flex; margin-right: 10px;">
        ...
        <p style="margin-top: 20px; margin-left: 10px;font-size:12px">Documents</p>
        <a class="links" href="/documents" style="margin-top: 23px; padding-left: 10px; font-size: 12px;  color: black; text-decoration: none;">
  <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='blue'; this.style.textDecoration='none';">
    ...
    <div class="col-md-3" style=" border-radius: 5px; border: 1px solid #D9D9D9; background-color: white; display: flex; margin-right: 10px;">
        <img src="https://t4.ftcdn.net/jpg/01/16/49/93/240_F_116499398_HdQiZjmQVbw3qJs5PwmttBuAxoIyRq7Y.jpg" alt="Image Description" style="height: 30px; width: 40px; margin-top: 20px; margin-left: 10px;">
        <p style="margin-top: 20px; margin-left: 10px;font-size:12px">Payslip</p>
        <a class="links" href="/payslip" style="margin-top: 23px; padding-left: 50px; font-size: 12px;  color: black; text-decoration: none;">
  <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='blue'; this.style.textDecoration='none';">
  View all
  </span>
</a>
    </div>
    <div class="col-md-3" style=" border-radius: 5px; border: 1px solid #D9D9D9; background-color: white; display: flex;">
        ...
        <p style="margin-top: 20px; margin-left: 10px;font-size:12px">Form 16</p>
        <a class="links" href="/documents" style="margin-top: 23px; padding-left: 30px; font-size: 12px;  color: black; text-decoration: none;">
  <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='blue'; this.style.textDecoration='none';">
    View all
  </span>
</a>
...
<div class="row" style=" margin-top: 20px;display:flex">
    <div class="col-md-3" style="background-color: white; border: 1px solid #D9D9D9; border-radius: 5px;display:flex">
        ...
        <p style="margin-top: 20px;margin-left:10px;font-size:12px">Policy</p>
        <a class="links" href="/documents" style="margin-top: 23px; padding-left: 30px; font-size: 12px;  color: black; text-decoration: none;">
  <span onmouseover="this.style.color='#33B3BC'; this.style.textDecoration='underline';" onmouseout="this.style.color='blue'; this.style.textDecoration='none';">
  View all
  </span>
