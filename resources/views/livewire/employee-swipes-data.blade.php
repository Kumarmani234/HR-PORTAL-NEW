...
<div>
    ...
    <div class="dropdown-container1-employee-swipes">
          ...
          <input type="text" name="daterange" class="dropdown-btn1"wire:model="date" value="01/04/2024 - 01/04/2024" style="font-size: 13px;" wire:change="dateRange($event.target.value)" />
    ...
    <!-- Display the filtered collection or any other content -->
        ...
        <!-- Display swipe details -->
                       <tr style=" border-bottom: 1px solid #ccc;">
                              <td  style=" white-space: nowrap;font-size:12px;padding-left:10px;">
                                        <input type="checkbox" name="employeeCheckbox[]"style="margin-left:-5px;height:10px;" value="{{ $swipe->emp_id }}">
                              ...
                              <td style=" white-space: nowrap;padding-left:12px;">{{$swipe->swipe_time}}<br /> <span class="text-muted"style="font-size:10px;">{{ \Carbon\Carbon::parse($swipe->created_at)->format('d M, Y') }}</span></td>
                              <td style=" white-space: nowrap;padding-left:12px;">10:00 am to 07:00...</td>
                              <td style=" white-space: nowrap;padding-left:12px;">{{$swipe->in_or_out}}</td>
                              <td style=" white-space: nowrap;padding-left:12px;">{{$swipe->swipe_time}}<br /><span class="text-muted"style="font-size:10px;"> {{ \Carbon\Carbon::parse($swipe->created_at)->format('d M, Y') }}</span></td>
        ...
        <div class="container-employee-swipes-right">
                <div class="green-section-employee-swipes"style="height: 180px;width: 150%; position: relative;  margin-left: -20px; padding-right: 20px;padding-bottom:60px;">
                     ...
                     <img src="https://cdn-icons-png.flaticon.com/512/2055/2055568.png" style="width: 18%; height: 16%;margin-top:30px;margin-left:10px;border-radius:50%;">
                ...
                <p style="font-size: 13px; font-weight: 500;margin-top:2px;">{{$this->status}}</p>
                <p style="font-size: 14px; margin-top: 10px;color:#666;">Access Card</p>
                <p style="font-size: 18px; font-weight: 500;margin-top:-2px;">-</p>
