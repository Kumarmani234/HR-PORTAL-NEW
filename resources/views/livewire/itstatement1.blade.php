...
<a href="/itform" id="pdfLink2024" class="cus-button" download style="margin-left:-40px; padding: 2px;    margin-bottom:15px; background-color:#3eb0f7;
        color: #fff;  width:100px;margin-right:40px;height:40px;border: none;border-radius: 4px;cursor: pointer;"></a>  
...
<div class="row" style="display: flex">
    <div class="column" style="width: 170px; height: 100px; border: 1px solid silver; border-radius: 5px; background: white; margin-top: 40px; margin-left: 20px">
        ...
        <div style="border:1px solid silver ;height:1px;width:100%;margin-top:-10px;"></div>
    ...
    <div class="column" style="width: 170px; height: 100px; border: 1px solid silver; border-radius: 5px; background: white; margin-top: 40px; margin-left: 10px">
        <p style="font-size: 11px;margin-top:5px;margin-left:30px">TAX DEDUCTIBLE IN ₹</p>
        <div style="border:1px solid silver ;height:1px;width:100%;margin-top:-10px;"></div>
        <p style="font-size:24px;margin-top:10px;margin-left:40px">0.00</p>
    </div>
...
<div _ngcontent-ffh-c446="" class="expand-collapse">
  <button id="collapseExpandBtn" class="btn btn-link ng-star-inserted"><p  style="margin-top:10px">Collapse all</p></button>
...
<div id="incomeContainers" style="display: none; width: 850px;">
    <div class="row" style="display: flex; width: 100%;">
        <div class="column" style="height: 40px; background: #AFC8ED; width: 100%; margin-left: 10px; display: flex; margin-top: 10px;">
            <p style="margin-top: 12px; margin-left: 5px; font-size: 10px;">Items</p>
            <p style="margin-top: 12px; margin-left: 80px; font-size: 10px;">Total</p>
            <div class="column" style="display: flex;white-space: nowrap; width: 100%;">
                <table class="income-table" style="width: 100%; font-size: 10px;">
                    <tr class="monthly-data" style="font-size: 10px;">
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 40px;">Jan 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Feb 2023</td>
                        <td class="total-amount"  style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Mar 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Apr 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">May 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Jun 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Jul 2023</td>
                        <td class="total-amount"  style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Aug 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Sep 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Oct 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Nov 2023</td>
                        <td class="total-amount" style="font-size: 10px; margin-top: 12px; padding-left: 10px;">Dec 2023</td>
                        <!-- Add more months here -->
                    </tr>
                </table>
            </div>
        </div>
        <p class="monthly-data" style="font-weight: normal; margin-top: 4px; background: white; height: 40px; width: 890px; margin-left: 10px;">Monthly Income</p>
    </div>
    ...
    <div class="row" style="height: 250px; width: 106%; display: flex; background: white; margin-left: -2px; margin-top: -14px;">
        <div class="column" style="display: flex; margin-top: -5px; margin-right: 10px;">
            ...
            <div class="column" style="display: flex; white-space: nowrap; width: 100%; margin-top: 5px;">
                <table class="income-table" style="width: 106%; margin-top: 5px;">
                    <tr class="monthly-data" style="font-size: 10px;">
                        <td class="total" style="font-size: 10px;">Basic</td>
                        <td class="total-amount" style="font-size: 10px;">{{ number_format($employee->basic*12, 2) }}</td>
                        <td style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount"  style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        ...
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
        <td class="total-amount" style="font-size:10px;">{{ number_format($employee->basic, 2) }}</td>
                        <!-- Add other cells for months -->
                    </tr>
                    <tr class="monthly-data" style="font-size: 10px;">
                        <td class="monthly-data" style="font-size: 10px;">HRA</td>
                        <td  class="monthly-data" style="font-size: 10px;">{{ number_format($employee->hra*12, 2) }}</td>
                        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        ...
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="monthly-data" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->hra, 2) }}</td>
                        <!-- Add other cells for months -->
                    </tr>
                    <tr class="monthly-data" style="font-size: 10px;">
                    <td class="total-amount" style="font-size:10px">Conveyance</td>
                    <td class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
        <td class="total-amount" class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->conveyance, 2) }}</td>
    ...
    <tr class="monthly-data" style="font-size: 10px;">
    <td class="total-amount" style="font-size:10px">Medical</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical*12, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->medical, 2) }}</td>
    ...
    <tr class="monthly-data" style="font-size: 10px;">
    <td  class="total-amount" style="font-size:10px">Special Allowance</td>
    <td  class="total-amount" style="font-size:10px">{{ number_format($employee->special*12, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td class="total-amount" style="font-size:10px">{{ number_format($employee->special, 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->special, 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->special, 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->special, 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->special, 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->special, 2) }}</td>
                    ...
                    <tr class="monthly-data" style="font-size: 10px; background: #C3C7CD; width: 110%;">
                        <td style="font-size: 10px;" class="total-amount">Total Allowance</td>
                        <td style="font-size: 10px;" class="total-amount">{{ number_format($employee->calculateTotalAllowance()*12, 2) }}</td>
                   
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->calculateTotalAllowance(), 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->calculateTotalAllowance(), 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->calculateTotalAllowance(), 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->calculateTotalAllowance(), 2) }}</td>
        <td style="font-size:10px" class="total-amount">{{ number_format($employee->calculateTotalAllowance(), 2) }}</td>
...
@endforeach
    ...
    <div style="width: 106%; margin-left: -10px; margin-top: 5px;">
    ...
    <div class="column" style="display: flex; white-space: nowrap; width: 100%; margin-left: 40px;">
        <table class="deductionsdata" style="width: 100%;">
            <tr  class="data-deductions" style="width: 100%;">
                <td style="font-size: 10px; margin-top: 12px; margin-left: 60px;">Jan 2023</td>
                ...
                <td style="font-size: 10px; margin-top: 12px; margin-left: 10px;">July 2023</td>
                ...
                <div class="row" style="height: 120px; width: 100%; margin-left: 0; display: flex; background: white;">
                    <div class="column" style="display: flex; margin-top: 5px; margin-left: 0;">
                        <p style="margin-top: 23px; margin-left:5px; font-size: 13px; width: 100px;">PF</p>
                        <p style="margin-top: 24px; margin-left: 30px; font-size: 10px; width: 50px;">{{ number_format($employee->calculatePf()*12, 2) }}</p>
                        <div class="column" style="display: flex; white-space: nowrap; width: 100%; margin-left: 30px; margin-top: 10px;">
                            <table style="width: 100%;">
                                <tr style="width: 100%;">
                                    <td style="font-size: 10px; margin-top: 12px; margin-left: -160px;">{{ number_format($employee->calculatePf(), 2) }}</td>
                                    <td style="font-size: 10px; margin-top: 12px; margin-left: -100px;">{{ number_format($employee->calculatePf(), 2) }}</td>
                                    <td style="font-size: 10px; margin-top: 12px; margin-left:-20px;">{{ number_format($employee->calculatePf(), 2) }}</td>
                                    <td style="font-size: 10px; margin-top: 12px; margin-left: -20px;">{{ number_format($employee->calculatePf(), 2) }}</td>
                    ...
                    <div class="column" style="display: flex; margin-top: 5px; margin-left: 0;">
                        <p style="margin-top: 23px; margin-left: 2px; font-size: 13px; width: 100px;">PROTAX</p>
                ...
                <div  style="width: 106%; margin-left: -30px;margin-top:5px">
...
<div style="width: 106%; margin-left: -16px; margin-top: 100px;">
    <div class="row" style="width: 850px; height: 50px; border-radius: 5px; border: 1px solid silver; margin-left: 12px; background: white; margin-top: 20px;">
        <div class="column" style="display: flex;">
